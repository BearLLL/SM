...
### 二、密钥处理
    1.加密密钥长度为128比特，分为四项32位的字。MK=(MK0,MK1,MK2,MK3)
    2.系统参数，每项为32位的字。FK=(FK0,FK1,FK2,FK3)
    3.固定参数，用于密钥扩展算法，每项为32位的字。CK=(CK0,CK1,...,CK31)
    4.轮密钥，每项为32位的字，由密钥扩展算法生成。(rk0,rk1,...,rk31)
